...
function Hero() {
  ...
  <div className="hero-des flexColStart">
    <span className='secondaryText'>
      Find a varity of properties that suit you very easilty
    </span>
    <span className='secondaryText'>Forget all diffrent in finding a residences for you</span>
  </div>
...
<div className="flexCenter stats">
  <div className="flexColCenter stat">
    ...
    <span className='secondaryText'>Premimu Product</span>
  </div>
  <div className="flexColCenter stat">
  ...
  <div className="flexColCenter stat">
    <span><CountUp  end={30} /><span>+</span></span>
